...
!function(factory) {
  ...
  vertx.EventBusWS = function(url, options) {
    ...
    var that = this;
    alert(url);
    var sockJSConn = new WebSocket(url);
    var handlerMap = {};
    var replyHandlers = {};
    var state = vertx.EventBusWS.CONNECTING;
    ...
    that.close = function() {
      checkOpen();
      state = vertx.EventBusWS.CLOSING;
      sockJSConn.close();
    }
    ...
    function checkOpen() {
      if (state != vertx.EventBusWS.OPEN) {
  ...
  vertx.EventBusWS.CONNECTING = 0;
  vertx.EventBusWS.OPEN = 1;
  vertx.EventBusWS.CLOSING = 2;
  vertx.EventBusWS.CLOSED = 3;

  return vertx.EventBusWS;
